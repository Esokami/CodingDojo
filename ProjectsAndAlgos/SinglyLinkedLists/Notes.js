...
class LinkedList {
    ...
    addFront(val) {
        ...
        //Checking to see if the current list does ont have a head node (if the list is empty)
    ...
    findSum(){
        ...
        let sum = 0;
        //Since a Linked List does not know how many nodes is within it, we will not be able to use a for loop to            
        //iterate, instead we'll use a while
