# we will need to import buger.py to access the class
...
class Topping:
    def __init__(self, data):
        ...
        # we need to have a list in case we want to show which burgers are related to the topping
        self.on_burgers = []
    ...
    def get_topping_with_burgers(cls, data):
        ...
        for row_from_db in results:
            ...
            burger_data = {
                    ...
                    "updated_at" : row_from_db["toppiings.updated_at"]
            }
